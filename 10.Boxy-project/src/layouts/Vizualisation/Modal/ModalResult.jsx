    ...
    >
      ...
      >
        <div className="flex items-end mb-5">
          <p className="font-semibold mr-5">Here is your code 🏄🏻‍♂️</p>
          <button
          onClick={handleCopy}
          className="self-start ml-auto mr-2 text-sm bg-blue-600 text-white hover:bg-blue-700 py-1 px-3 rounded">
            Copy
          </button>
